// ITDB02_Graph16_Demo_Widescreen (C)2011 Henning Karlsen
// web: http://www.henningkarlsen.com/electronics
//
// This program is a demo of how to use most of the functions
// of the library with a supported 16bit widescreen display
// module.
//
...
//ITDB02 myGLCD(19,18,17,16,ITDB32WC);   // Remember to edit the parameter for your display if you are not using an ITDB02-3.2WC!

// Uncomment the next line for Arduino Mega
ITDB02 myGLCD(38,39,40,41,ITDB32WC);   // Remember to edit the parameter for your display if you are not using an ITDB02-3.2WC!
...
// Clear the screen and draw the frame
  ...
  myGLCD.print("--*** WQVGA TFT 400x240 Color Display ***--", CENTER, 1);
  myGLCD.setBackColor(64, 64, 64);
  myGLCD.setColor(255,255,0);
  myGLCD.print("http://www.henningkarlsen.com/electronics", CENTER, 227);
